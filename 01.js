            ...
            if (message.includes("|")) {
                ...
                for (let i = 0; i < sections.length; i += 2) {
                    ...
                    if (area && docentes) {
                        ...
                        // Crear lista numerada de docentes
                        ...
                        container.appendChild(ulDocentes);
                    }
                }
                ...
                // Excepción para la respuesta de "historia"
                if (message.includes("La historia del Fabio inicia con los inicios del Plan de Reforma")) {
                    // Mostrar como texto plano con saltos de línea
                    messageDiv.innerHTML = items.join("<br>");
                } else if (items.length > 1) {
                    // Crear título para listas simples
